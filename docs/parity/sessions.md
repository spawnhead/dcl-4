# Sessions Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/Sessions.jsp`.
- Legacy Struts action mappings:
- `/Sessions` → `net.sam.dcl.session.SessionsAction`

## Form beans
- `Sessions` → `net.sam.dcl.session.SessionsForm`.
