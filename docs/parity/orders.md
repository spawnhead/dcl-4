# Orders Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/Orders.jsp`.
...
- Candidate SQL resource IDs:
  ...
  - `test-select-orders-by-date`
  - `select-orders_statistics`
  - `select-orders_unexecuted`
  - `select-orders_logistics`
