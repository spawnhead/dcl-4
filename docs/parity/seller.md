# Seller Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/Seller.jsp`.
...
- Candidate DAO classes:
  - `src/main/java/net/sam/dcl/dao/SellerDAO.java`
- Candidate SQL resource IDs:
  - `select-sellers`
  - `select-sellers-dao`
  - `select-sellers-for-order-dao`
  - `seller-insert`
  - `seller-update`
  - `seller-load`
  - `seller-delete`
  - `dao-load-seller`
  - `select_all_sellers_id`
