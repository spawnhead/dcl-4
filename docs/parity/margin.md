# Margin Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/Margin.jsp`.
...
- Candidate SQL resource IDs:
  - `select-margin-common`
  - `select-margin_proc-common`
  - `select-margin-common-paged`
  - `select-margin_proc-common-paged`
  - `select-margin-common-count`
  - `select-margin_proc-common-count`
