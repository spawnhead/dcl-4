# ProduceCost Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/ProduceCost.jsp`.
...
- Candidate DAO classes:
  - `src/main/java/net/sam/dcl/dao/ProduceCostProduceDAO.java`
  - `src/main/java/net/sam/dcl/dao/ProduceCostDAO.java`
