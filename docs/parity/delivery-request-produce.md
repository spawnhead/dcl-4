# DeliveryRequestProduce Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/DeliveryRequestProduce.jsp`.
...
- Candidate DAO classes:
  - `src/main/java/net/sam/dcl/dao/DeliveryRequestProduceDAO.java`
