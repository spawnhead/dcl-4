# CommercialProposalProduce Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/CommercialProposalProduce.jsp`.
...
- Candidate DAO classes:
  - `src/main/java/net/sam/dcl/dao/CommercialProposalProduceDAO.java`
