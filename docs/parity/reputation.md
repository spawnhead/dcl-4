# Reputation Parity Map (draft)
## Scope
- Legacy JSP: `src/main/webapp/jsp/Reputation.jsp`.
...
- Candidate DAO classes:
  - `src/main/java/net/sam/dcl/dao/ReputationDAO.java`
- Candidate SQL resource IDs:
  ...
  - `reputation-load`
  - `dao-load-reputation`
  - `dao-load-default-reputation`
  - `reputation-update-set_default_for_ctc`
